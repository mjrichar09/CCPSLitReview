...
Trade press and regulatory notices are not papers. Summarize what was announced or published and by whom; do not dress a press release up as a result.

Write in plain ASCII, using American spellings (titer not titre, behavior not behaviour, defense not defence, modeling not modelling, labeled not labelled, characterized not characterised, analyzed not analysed, program not programme, center not centre, analog not analogue). Use a straight apostrophe ('), never a curly one. Use a hyphen for ranges (1.6-7.4-fold, 2012-2025); avoid en and em dashes entirely. Under a JSON schema they have been observed coming back as a broken escape that lands as a stray newline mid-sentence. This governs your own prose only - never alter the wording of a paper title, an author name or a venue.`;
